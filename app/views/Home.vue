                    ...
                    <div class="grid grid-cols-12 grid-rows-9 w-full h-full">
                        ...
                        <div class="row-span-8 col-span-10 p-5 overscroll-none">
                            <div class="flex flex-col items-center bg-slate-50 mt-12 px-6 py-5 rounded-2xl" v-if="messages.length==0">
                                <h1 class="text-3xl font-medium">👋 Welcome to the Nova Orchestrator! 🌟</h1>
                                <div class="flex flex-col gap-3 mt-5 text-base">
                                    <p>We&#39;re excited to have you here! This project is designed to make your problem-solving experience seamless and efficient. Our <strong>Nova</strong> orchestrates a team of specialized AI agents to tackle complex queries and deliver precise solutions.</p>
                            ...
                            <div v-else class="flex flex-col gap-5 overflow-y-auto overflow-x-hidden scroll-smooth">
                                <component :key="message.id" v-for="message in messages" :is="message.role==='user'?'HumanMessage':'AIMessage'" :content="message.content"/>
                            </div>
                        </div>
                        <div class="row-span-8 col-span-1"></div>
                        <form @submit="submitHandler" class="row-span-1 col-span-full flex flex-row justify-center py-2 gap-3">
                            <button type="button" class="drop-shadow-md">
                                <svg class="w-9 h-9" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="18.25 18.25 63.5 63.5">

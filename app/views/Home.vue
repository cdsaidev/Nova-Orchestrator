                    ...
                    <div class="grid grid-cols-12 grid-rows-9 w-full h-full">
                        ...
                        <div class="row-span-8 col-span-10 p-5 overscroll-none">
                            <div class="flex flex-col items-center bg-slate-100 mt-14 px-5 py-3.5 rounded-2xl" v-if="messages.length==0">
                                <h1 class="text-3xl mb-3">👋 Welcome to Nova Orchestrator!</h1>
                                <div class="text-lg text-pretty">
                                    ...
                                    <p class="mt-2">Here’s how it works:<br>1️⃣ <strong>Nova</strong> orchestrates the process, delegating tasks to other agents.<br>2️⃣ These agents either:  </p>
                                    ...
                                    <p>3️⃣ The Nova keeps everything running smoothly until your entire query is solved!  </p>
